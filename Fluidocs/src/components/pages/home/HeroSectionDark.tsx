    ...
    (
        {
            ...
            ctaHref = "/signup",
            bottomImage = {
                light: "https://imgs.search.brave.com/AHuYH7FHZRvnP8nna3vvvEiDVVkLHPLyqDAUSChMems/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pbWFn/ZXMuY3RmYXNzZXRz/Lm5ldC9sem55MzNo/bzFnNDUvNE8xOEVY/bm80aUw3U1FMVUNi/RjZnVy8xZTM3ZmY4/MDQ5YWU5MWMyYjRk/ZDNlYmFhMmIxMTJl/ZC9ob3ctdG8td29y/ay13aXRoLWltYWdl/MHMtaW4tZ29vZ2xl/LWRvY3MtaW1hZ2Uw/OC5wbmc_dz0xNDAw",
        ...
        return (
            <div className={cn("relative", className)} ref={ref} {...props}>
                <div className="absolute top-0 z-[0] h-screen  bg-purple-950/10 dark:bg-purple-950/10 bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.15),rgba(255,255,255,0))] dark:bg-[radial-gradient(ellipse_20%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]" />
